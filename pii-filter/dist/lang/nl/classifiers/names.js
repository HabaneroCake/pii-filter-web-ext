...
export class PetName extends Parsing.CoreNameClassifier {
     ...
     */
    constructor() {
        super(ds_pet_name, 0.05, 0.10, 0.10, 0.05, 0.10);
        /** @inheritdoc */
        this.name = 'pet_name';
    }
}
...
export class MedicineName extends Parsing.CoreNameClassifier {
     ...
     */
    constructor() {
        super(ds_medicine_name, 0.10, 0.15, 0.10, 0.05, 0.20);
        /** @inheritdoc */
        this.name = 'medicine_name';
    }
}
;
