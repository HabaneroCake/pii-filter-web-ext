...
export interface PIIClassifier {
     ...
     */
    classify(text: string): PIIClassifierResult;
    /**
     * Removes/replaces PII in a string.
     * @param text the input string
     * @param placeholders whether to use placeholders
     */
    sanitize_str(text: string, placeholders: boolean): string;
    /**
     ...
     */
    sanitize_obj(obj: object, placeholders: boolean, recursive: boolean, skip?: Array<object>): object;
}
