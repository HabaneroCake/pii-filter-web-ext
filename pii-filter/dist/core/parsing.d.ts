...
export { CoreNameClassifier, CoreMultiNameClassifier } from './parsing/classifiers/name-classifier';
...
export { CoreClassifier, CoreClassification, CoreClassificationScore, CoreAssociativeScore, CoreAssociationScore, CoreAssociations, CoreConfidences, CoreThresholds, } from './parsing/classification';
